...
public class ButtonListener extends ListenerAdapter {
    ...
    private void handleSlotButton(ButtonInteractionEvent event, String[] buttonData) {
        ...
        // Defer edit immediately to prevent timeout during database operations
        ...
        switch (action) {
            ...
            default -> {
                ...
                event.getHook().sendMessage("Unknown slot button action. Please try again.").setEphemeral(true).queue();
                return;
            }
        }
