...
public class GameServer {
    ...
    public GameServer(long guildId, String name, String host, int port, String username, String password, 
        ...
        this.bountyChannelId = 0; // Default to 0, set by separate command
    ...
    public long getBountyChannelId() {
        return bountyChannelId;
    }
    
    public void setBountyChannelId(long bountyChannelId) {
        this.bountyChannelId = bountyChannelId;
    }
